...
public class AuthorController {
  ...
  private void initializeData() {
    ...
    this.addAuthorToCollection(new Author(-1, "James", "Kurose", 1960));
    this.addAuthorToCollection(new Author(-1, "Keith", "Ross", 1965));
    this.addAuthorToCollection(new Author(-1, "Jordan", "Peterson", 1960));
  }
  ...
  private void addAuthorToCollection(Author author) throws IllegalArgumentException {
    ...
    this.authors.put(id, new Author(id, author.firstName(), author.lastName(),
                                    author.birthYear()));
  }
